...
> **This document has been reorganized.** The setup process is now split into sequenced steps in [`docs/setup/`](setup/README.md) to make the ordering dependency between Losant configuration and cluster deployment explicit.
...
**[Start the setup guide →](setup/README.md)**
